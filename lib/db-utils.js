...
const addEmployee = async function () {
  ...
  // Add an "Other" option to the list of managers
  ...
  if ((indexInManagersArray = managersArray.length - 1)) {
    ...
    // console.log(allEmployeesResults);
